...
const Request = () => {
  ...
  // const [isLayananPopupOpen, setLayananPopupOpen] = useState(false);

  const [isLayananPopupOpen, setLayananPopupOpen] = useState(false);

  // Other state variables and useEffects remain the same as in your original code

  const openPopup = () => {
    setLayananPopupOpen(true);
  };

  const closePopup = () => {
    setLayananPopupOpen(false);
  };
...
// </div>
    ...
    <div className="request">
      <div className="form-container">
        ...
        <form>
          {/* TRANSAKSI */}
          <fieldset className="form-transaksi">
        ...
        {isLayananPopupOpen && (
          ...
          <div className="popup">
            <form>
            <fieldset className="form-layanan-left">
        ...
        <fieldset className="form-layanan-right">
        {/* <hr />
          <center>
        ...
        {/* PEMBAYARAN */}
        <form>
          <fieldset className="form-pembayaran">
